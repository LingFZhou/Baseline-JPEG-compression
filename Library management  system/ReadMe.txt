...
LibraryDoc.h, LibraryDoc.cpp - the document
    These files contain your CLibraryDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CLibraryDoc::Serialize).

LibraryView.h, LibraryView.cpp - the view of the document
    These files contain your CLibraryView class.
    CLibraryView objects are used to view CLibraryDoc objects.
