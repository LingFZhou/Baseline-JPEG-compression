...
public class maping_data extends PApplet {
...
if(drawgraph==1&&drawed!=-1)
{
  ...
  noStroke();
  drawingspeed++;
  float drawto=drawingspeed*0.05f;
  if(drawto<1)
  {
...
if(drawyeargraph==1)
{
  ...
  noStroke();
  drawingyearspeed++;
  float drawyearto=drawingyearspeed*0.05f;
  if(drawyearto<1)
  {
...
public void datayearpoints(int j){
...
public void drawyearpoints(int j){
  int x=10;
  for(int i=0;i<31;i++){
    noStroke();
    rectMode(CORNER);
    fill(0,0,0,150);
    rect(yeargraphx+x,yeargraphy+192.5f,16.5f,yearlinePoint4[i][j]);
    
    fill(247,68,97);
    rect(yeargraphx+x,yeargraphy+192.5f-yearlinePoint1[i][j],5.5f,yearlinePoint1[i][j]);
    
    fill(26,111,35);
    rect(yeargraphx+x+5.5f,yeargraphy+192.5f-yearlinePoint2[i][j],5.5f,yearlinePoint2[i][j]);
    
    fill(253,218,4);
    rect(yeargraphx+x+11,yeargraphy+192.5f-yearlinePoint3[i][j],5.5f,yearlinePoint3[i][j]);
...
public void drawyearline(){
  stroke(0,0,0);
  strokeWeight(5);
  line(yeargraphx+5,yeargraphy+192.5f,yeargraphx+635,yeargraphy+192.5f);
}
public void drawyearnames(int j){
  fill(0);
  textSize(20);
  textAlign(CENTER,TOP);
  ...
  int x=10;
  for(int i=0;i<31;i++){
    if(mouseX<yeargraphx+x+20*(i+1)&&mouseX>yeargraphx+x+20*i&&mouseY<342.5f+yeargraphy&&mouseY>40+yeargraphy){
      fill(23,80,100);
      textSize(30);
  ...
  textSize(10);
  textAlign(LEFT,CENTER);
  text("deathrate",42.5f+yeargraphx,15+yeargraphy); 
  ...
  textSize(10);
  textAlign(LEFT,CENTER);
  text("air",42.5f+yeargraphx,30+yeargraphy); 
  ...
  textSize(10);
  textAlign(LEFT,CENTER);
  text("greenland",42.5f+yeargraphx,45+yeargraphy);
  ...
  textSize(10);
  textAlign(LEFT,CENTER);
  text("wasted water",42.5f+yeargraphx,60+yeargraphy); 
...
class readdata {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "maping_data" };
    if (passedArgs != null) {
